...
const Home = () => {
  const settings = {
    ...
    autoplay: true,
    autoplaySpeed: 3000,
    adaptiveHeight: true, // ✅ added for better mobile fit
  };
        ...
        <Box>
          <Typography
            ...
            sx={{
              ...
              lineHeight: 1.2,
              fontFamily: "cursive",
              fontSize: { xs: "2rem", md: "3rem" }, // ✅ responsive text
            }}
          >
            Master Your Money.{" "}
            ...
            <CardContent>
              <Typography
                ...
                sx={{
                  ...
                  mb: 2,
                  fontFamily: "Arial , sans-serif",
                  textAlign: { xs: "center", md: "left" }, // ✅ responsive text align
                }}
              >
              ...
              >
                <Box
                  sx={{
                    width: { xs: "100%", md: 200 }, // ✅ responsive width
                    height: { xs: "auto", md: 160 },
                    display: "flex",
                    justifyContent: "center",
                    alignItems: "center",
                    borderRadius: 3,
                    mb: { xs: 2, md: 0 }, // ✅ spacing fix
                  }}
                >
                  <img
                    src={budgetImg}
